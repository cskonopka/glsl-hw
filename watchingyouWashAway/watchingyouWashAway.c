...
void main() {
    ...
    colorMix = mix(colorA, colorB, ((sin(((y6-y2*(st.y-st.x))*0.174)-sin(((-y6-(y2+st.y))*0.74))+sin((cos(pct2*-0.92)))))) * ((-sin(((-y6+y2*(-st.y+st.x))*-0.174)+sin(((y6+(sin(-y2-st.y)+u_time*0.5))*-1.74))*sin((cos(-pct2+0.92)))))));
