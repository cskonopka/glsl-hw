// author --> cskonopka
// title ---> "whalefilteringHighEnergyProtons"
// format --> Fragment Shader
// link ----> http://glslsandbox.com/e#72177.1
...
void main() {
    ...
    float y2 = (smoothstep((-pct2*(sin(st.y/st.x*0.20)*.1519591321)+(sin(.49913212)))+(tan((-st.x+st.y)*0.120)),0.19229005,0.32*cos(-st.y*st.x*0.01125020))) / (smoothstep((cos((sin(-st.y+(st.x+0.02))*0.1321)+((tan(0.93913212))*cos(time)*0.2)))+(cos((st.y)*0.120)),st.y*0.19229005,(.1732*((cos(-st.y-st.x)*tan(0.293))+(sin(-st.x+st.y)*0.13)))));
    ...
    colorMix = smoothstep(colorC2*0.01910, (cos(colorC2*0.10193)/tan(colorC2*0.893))*cos(time*.003), (0.92*colorB+(cos(0.1919202)))*sin(time*0.93003));
