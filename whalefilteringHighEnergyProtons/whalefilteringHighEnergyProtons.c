...
void main() {
    ...
    float y2 = (smoothstep((-pct2*(sin(st.y/st.x*0.20)*.1519591321)+(sin(.49913212)))+(tan((-st.x+st.y)*0.120)),0.19229005,0.32*cos(-st.y*st.x*0.01125020))) / (smoothstep((cos((sin(-st.y+(st.x+0.02))*0.1321)+((tan(0.93913212))*cos(u_time)*0.2)))+(cos((st.y)*0.120)),st.y*0.19229005,(.1732*((cos(-st.y-st.x)*tan(0.293))+(sin(-st.x+st.y)*0.13)))));
