...
void main() {
    ...
    float y2 = (smoothstep((sin(-pct2*(sin(st.y/st.x)*0.591321)-(sin(.913212))))+(tan((st.x)*0.20)),0.229005,0.32/cos(-st.y+st.x))) / (smoothstep((cos(-pct2*(sin(st.y*(st.x*0.02))*0.1321)-(cos(u_time*0.13212))))+(sin((st.x)*0.20)),0.229005,0.32));
