...
void main() {
    ...
    float y = (smoothstep((sin(-pct2*((sin(st.y+st.x))*0.01)*(cos(0.913212))))*(cos((st.y)*1.20)),(0.1229005),(0.0132)))/(smoothstep((sin(pct2*((cos(st.y-(st.x*st.y)))*0.0942001)*(cos(1.13212))))*(sin((st.x+st.y)*.20)),(0.229005),(.1732*((cos(-st.y-st.x)*sin(20.93))/(cos(-st.x+st.y)*0.3)))));
