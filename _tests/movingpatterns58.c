...
void main() {
    ...
    colorMix = mix(colorA, colorB, ((sin(u_time*((y6-y2*(-st.y+st.x))*0.174)) - (sin(u_time*((-y6+y2*(st.y-st.x))*0.174))))*(sin(u_time-((-y6+(y3*(st.y-st.x))*0.74))+sin((cos(pct2*10.92)))) +  (sin(u_time+((-y6+(y3*(-st.y+st.x))*10.74))+sin((cos(pct2*0.92))))))));
    // colorMix = mix(colorA, colorB, (sin(u_time-((y6*y3*(-st.y+st.x))*0.00174)))+(sin(u_time-((-y6*y3*(st.y-st.x)*0.9022)*(10.91+ sin(u_time*0.9174)*10.2)))));
