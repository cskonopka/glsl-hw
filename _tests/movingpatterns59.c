...
void main() {
    ...
    colorMix = mix(colorA, colorB, ((sin(u_time*((y6*y2*(st.y-st.x))*0.174)-sin(u_time*((-y6*y2*(st.y-st.x))*30.74))+sin((cos((pct2*-0.92)+st.x*st.y)*0.0041))))) * ((-sin(u_time*((-y6*y2*(-st.y*st.x))*-0.174)+sin(u_time*((y6-y2-(st.y))*-0.74))-sin((cos(-pct2*0.92)))))));
