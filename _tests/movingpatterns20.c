...
void main() {
    ...
    float pct3 = 0.0;
    pct3 = distance(st*-0.32,vec2(-11.5));

    float y3 = (sin((-st.y)*(1.10)))-sin(-pct2*(-3.12+3.12));
    float y = smoothstep(0.2,2.5,st.x) - smoothstep(10.5,0.191,(st.x*-(cos(-32.12))));
    float y2 = smoothstep(120.1,1.5,st.x) - smoothstep(3.1,3.18,-32.92*-st.y*20.0);
