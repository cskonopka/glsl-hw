...
void main() {
    ...
    // colorMix = mix(colorA, colorB, ((sin(u_time*((y6+y2*(st.y-st.x))*20.174)))+(sin(u_time*((-y6*y2*(st.y*st.x))*3.74))+sin(u_time*((-y2+y6)*((st.x*-st.y))*0.2041)))) * ((sin(u_time*((y6+y2*(st.y-st.x))*3.174)))+(sin(u_time*((-y6*y2)*(st.x*-st.y))*0.74))));
    colorMix = mix(colorA, colorB, ((sin(u_time*((y6+y2*(st.y-st.x))*0.2174)))+(sin(u_time*((-y6*y2*(st.y*st.x))*0.74))+sin(u_time*((-y2+y6)*((st.x*-st.y))*0.2041)))))*sin(u_time*((y6*y2*(st.y-st.x))*20.2174));
