...
void main() {
    ...
    vec3 colorA = vec3(y*y2)+(y3*(u_time*10.013));
    colorA = (1.0)*colorA*vec3(.90,0.920,(100.0+(sin(y3+(u_time*0.12)))));

    float y4 = cos(cos((st.y-st.x)*(sin(u_time*0.1913))*cos(0.43*st.x+st.y))) * cos(cos((-st.y+st.x)*(sin(u_time*-.1913))*sin(u_time*.821)*cos(0.3)));
