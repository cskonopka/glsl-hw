...
void main() {
    ...
    colorB = (1.0)*colorB*vec3(.1289281990*(st.y+(cos(st.x)+cos(st.y*(0.082*cos(-st.y*sin(st.y)))))),0.01294120*cos((st.x-(st.y-st.x*(-0.92013+-st.y)))*0.802),(0.084139230*(cos(y2+st.y*(01.97012))+(-st.y*st.x)))*(tan((1.0*(-st.y*-st.x)))*(.20*cos(-st.y+st.x))));
