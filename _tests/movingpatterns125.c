...
void main() {
    ...
    colorB = (1.0)*colorB*vec3(.189281990,0.294120*tan((st.x/st.y)*0.02),(0.084139230*(sin(y2-st.y*(0.97012))+(-st.y*st.x)))-(tan((1.0*u_time*(-st.y*-st.x)))* (1.0*u_time*(-st.y+st.x))));
    ...
    colorMix = mix(colorC*0.0, colorC2*0.93, (0.2*sin(u_time*0.9202)));
