...
void main() {
    ...
    float y2 = (smoothstep((-pct2*(sin(st.y/st.x*0.120)*.1519591321)+(sin(.0149913212)))+(tan((-st.x+st.y)*0.20)),0.9229005,0.212832*cos(-st.y*st.x*0.15020))) / (smoothstep((cos((sin(st.y*(st.x*0.02))*0.1321)+((tan(0.293913212))*cos(u_time)*0.2)))+(cos((st.y+st.x)*0.20)),st.y*0.19229005,(.1732*((cos(-st.y-st.x)*tan(0.1293))+(sin(-st.x+st.y)*0.013)))));
