...
void main() {
    ...
    float y = (smoothstep((tan(-pct2*((cos(sin(st.x)))*tan(0.022231))+(cos(0.191913212))))*(tan((st.y)*0.20)),(0.0033229005),(2.9132)))/(smoothstep((tan(pct2*((-cos(st.y-st.x))*0.42001)*(cos(2.13212))))*(sin((-st.x+st.y)*.820)),(0.8229005),(.1732*((cos(-st.y-st.x)*tan(2.93))+(cos(-st.x/st.y)*1.13)))));
