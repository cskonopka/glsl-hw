...
void main() {
    ...
    float y = (smoothstep((sin(-pct2*((sin(st.y+st.x))*0.01)*(cos(0.1913212))))*(cos((st.y)*1.20)),(0.229005),(0.132)))/(smoothstep((sin(pct2*((cos(st.y-(st.x*st.y)))*0.0942001)*(cos(02.13212))))*(sin((st.x+st.y)*.20)),(0.229005),(.732*((cos(-st.y-st.x)*tan(20.93))/(cos(-st.x+st.y)*0.3)))));
