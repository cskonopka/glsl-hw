...
void main() {
    ...
    float y = (smoothstep((tan(-pct2*((cos(sin(st.x)))*tan(0.1022231))+(cos(0.0191913212))))*(tan((st.y)*0.20)),(0.0033229005),(2.9132)))/(smoothstep((tan(pct2*((-cos(st.y-st.x))*0.42001)*(cos(2.13212))))*(sin((-st.x+st.y)*.820)),(0.8229005),(.1732*((cos(-st.y-st.x)*tan(2.93))+(cos(-st.x/st.y)*1.13)))));
    // float y = (smoothstep((cos((sin(st.y))+u_time*0.3212))/(cos((st.x)*0.2301)),0.9005,(sin((st.y)*3.301))/sin((st.x)*.301)));

    float y2 = (smoothstep((-pct2*(sin(st.y/st.x*0.120)*.1519591321)+(sin(.9149913212)))+(tan((-st.x+st.y)*0.20)),0.9229005,0.12832*cos(-st.y*st.x*0.25020))) / (smoothstep((cos((sin(st.y*(st.x*0.02))*0.1321)+((tan(0.93913212))*cos(u_time)*0.2)))+(cos((st.y)*0.20)),st.y*0.19229005,(.1732*((cos(-st.y-st.x)*tan(0.293))+(sin(-st.x+st.y)*0.13)))));
