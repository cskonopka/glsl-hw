...
void main() {
    ...
    float y2 = (smoothstep((sin(-pct2*(sin(st.y/st.x)*0.9591321)-(sin(.09913212))))*(tan((-st.x+st.y)*0.20)),0.229005,0.2832/cos(-st.y*st.x*0.020))) / (smoothstep((cos(-pct2*(sin(st.y*(st.x*0.02))*0.1321)-(tan(0.91913212))))+(cos((st.y)*0.20)),0.9229005*(sin(u_time*0.3)),0.132));
