...
void main() {
    ...
    float y2 = (smoothstep((-pct2*(sin(st.y/st.x*0.20)*.1519591321)+(sin(.149913212)))+(tan((-st.x+st.y)*0.20)),0.9229005,0.12832*cos(-st.y*st.x*0.5020))) / (smoothstep((cos((sin(st.y*(st.x*0.02))*0.1321)-(tan(0.1913212))))+(cos((st.y)*0.20)),st.y+0.19229005,(.1732*((cos(-st.y-st.x)*tan(2.293))*(acos(-st.x+st.y)*0.3)))));
