...
void main() {
    ...
    vec3 colorA = vec3(y*y2)+(y3*(0.013));
    // colorA = (1.0)*colorA*vec3(.90,0.920,(100.0+(sin(y3+(u_time*1.12)))));
    colorA = (1.0)*colorA*vec3(.90,0.920,(100.0+(sin(y3))));

    float y4 = cos(cos((st.y-st.x)*(sin(0.1913))*cos(0.43*st.x+st.y))) * cos(cos((-st.y+st.x)*(sin(-.1913))*sin(0.21)*cos(0.3)));
