...
void main() {
    ...
    float y4 = fract(cos((st.x)*(u_time*0.13)*cos(1.0*u_time)));
    float y5 = smoothstep(0.2,0.5,st.y) - smoothstep(0.25,0.1,(st.y*0.22));
    float y6 = smoothstep(0.1,0.15,st.x+cos(st.y)) - smoothstep(0.41,0.8,st.x);
