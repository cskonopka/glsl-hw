...
void main() {
    ...
    float y2 = (smoothstep((tan(-pct2*(sin(st.y/st.x*2.0)*.519591321)-(sin(.149913212))))+(tan((-st.x+st.y)*0.20)),0.9229005,0.12832*cos(-st.y*st.x*0.5020))) / (smoothstep((cos(-pct2*(sin(st.y*(st.x*0.02))*0.1321)-(tan(0.1913212))))+(cos((st.y)*0.20)),st.y/0.19229005,(.1732*((cos(-st.y-st.x)*tan(20.293))/(cos(-st.x+st.y)*0.3)))));
    ...
    colorMix = smoothstep(colorC*0.910, (cos(colorC2*0.10193)*tan(colorC2*0.893))*cos(u_time*.003), (0.92*colorB+(cos(0.1919202)))*sin(u_time*0.003));
