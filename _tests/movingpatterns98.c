...
void main() {
    ...
    float y = (smoothstep((sin((sin(st.y*st.x))+u_time*0.3212))/(sin((st.x)*1.0)),0.9005,0.32));
    ...
    float y3 = sin(tan((st.y+(sin(u_time*0.242)+st.x)*0.94)*(0.590)))+sin(st.x*0.12) - cos(sin((st.y)*(-2.13)))+sin(st.y*1.12);
