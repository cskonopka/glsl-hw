...
void main() {
    ...
    float y2 = (smoothstep((-pct2*(sin(st.y/st.x*0.120)*.1519591321)+(sin(.19149913212)))/(tan((-st.x+st.y)*0.20)),0.91229005,0.212832*cos(sin(-st.y+st.x)*0.25020))) / (smoothstep((cos((sin(st.y*(st.x*0.02))*0.1321)+((tan(0.193913212))*cos(u_time)*0.2)))+(tan((st.y)*0.20)),st.y*0.19229005,(.91732*((sin(sin(-st.y-st.x)*u_time)*sin(0.1293))*(sin(-st.x+st.y)*0.13)))));
